...
The Node.js framework I decided to use is [koa.js](https://koajs.com/). They have all of their functions and how to use them included on their website, so my project aimed to illustrate those functions in a more artistic and creative way. I made the website design similar to other Node.js framework websites, because the koa.js website is already quite uniquely designed and minimalistic.
...
Koa's request object includes helpful content negotiation utilities powered by [accepts](https://github.com/jshttp/accepts) and [negotiator](https://github.com/jshttp/negotiator). These utilities are:
